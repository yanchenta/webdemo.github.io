...
function resetGamges(str){
	...
	$('.popup1').css({"right":"0","display":"none"});
	areaString='12345678',stepFlag=false,isShowAgg=false;
...
$(document).ready(function(){
	$('.step6-sharebox').html('<h2 style="color:rgb(69,111,56);line-height:75px; text-align:center;">活动已结束，谢谢关注！</h2>');
...
var areaString='12345678',stepFlag=false,isShowAgg=false,secondTouch=false;
