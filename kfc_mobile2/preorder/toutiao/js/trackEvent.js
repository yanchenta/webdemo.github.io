...
var trackPath = "http://ama.adwo.com.cn/tracknew/advTract/tractEventJsonP.action?";
var trackScript;
function track(cId, eventId, url) {
    ...
    if (url != undefined && url != null && url != "") {
		...
		window.cms_redirecturl = url;//使用全局变量window.cms_redirecturl存储跳转用的url;
        function redirection() {
            window.location.href = window.cms_redirecturl;
        }
    }
}
