...
function submit_reg(registerSucFunc){
	...
	*/
	...
	//
	//新注册接口
	doRegistration(mobile, myname, province, city, 0, 'pad', registerSucFunc, $.cookie("utm_source"), $.cookie("utm_medium"), $.cookie("utm_content"), $.cookie("utm_campaign"));
	/*var source = "pad";
...
function submit_form(type){
	...
	if(1 == type){//..........................注册邀请
		...
		var succFunc = function(data){	//1. 激活(注册)
			...
			$.cookie("identity", "Club");//激活成功后，修改identity数据
		...
		doRegistration(mobile, myname, province, city, 0, 'pad', succFunc, $.cookie("utm_source"), $.cookie("utm_medium"), $.cookie("utm_content"), $.cookie("utm_campaign"));
