...
function showText(num){
	...
	switch(num){
		case 1 :
			...
			break;
		case 2 :
			$('#bg').css('-webkit-transform','translate(-110px,0)');
			$('.text2').show();
			break;
		case 3 :
			$('#bg').css('-webkit-transform','translate(-90px,0)');
			$('.text3').show();
			break;
		case 4 :
			$('#bg').css('-webkit-transform','translate(-190px,0)');
			$('.text4').show();
			break;
		case 5 :
...
function goToDetailed(){
	...
	var callBackUrl = encodeURIComponent("http://catwaji.mobileone.com.cn/xiangqing.php?cate=middle&type=0");
